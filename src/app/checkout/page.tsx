  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      if(validateForm()) {
        ...
        Swal.fire (
          "Success!"
          ,"Your Order has been successfully Processd!",
          "success",
        )
      }else {
        Swal.fire(
          "Error!",
          "Please fill in all Fields befaore Proccessd",
        "error",
        )
      }
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white border rounded-lg p-6 space-y-6">
            ...
            <button
              className="w-full rounded-full h-12 bg-stone-500 hover:bg-stone-700 text-white"
              onClick={handlePlaceOrder}
            >
              Place Order
            </button>
            <Link href='/stripe-payment' className="w-full md:w-38 py-[10px]
